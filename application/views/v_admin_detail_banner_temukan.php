...
<div class="mycontent" style="overflow-x: hidden; ">
	<div class="container">
		...
		<div class="col-sm-6" class="cop">
			...
			<h4 style="text-align:center;">TEMUKAN WAKASA</h4>
	...
	<hr class="bold">
	<br/>
	<form class="form-horizontal" action="<?php echo base_url(); ?>Backend/update_banner_temukan" method="POST" enctype="multipart/form-data">
