		...
		<div class="content">
			<div class="container">
				...
				<div class="col-sm-6" id="content_right">
					...
					<p id="p3">Sudah menjadi reseller Wakasa? Silahkan <span>daftar di sini</span> untuk dapat melihat katalog kami. mengunduh daftar harga dan mendapatkan informasi dari terbaru kami.</p>
				</div>
			</div>
		</div>
