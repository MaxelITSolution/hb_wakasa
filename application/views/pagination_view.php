    ...
    <?php for ($i = 0; $i < count($products); ++$i) { ?>
        <div class="col-sm-3">
            <div class="content_slider">
                ...
                <p class="desc_body">
                    <?php echo $products[$i]->remarks;?>
                </p>
                <a href="<?php echo base_url(); ?>asset/image/Upload/<?=$products[$i]->image;?>" data-lightbox="produk_login"><p class="desc_footer">SELENGKAPNYA &nbsp;></p></a>
            </div>
        ...
        <div class="col-md-8 col-md-offset-2 bg-border">
            <table class="table table-striped table-hover">
                ...
                <tr>
                    ...
                    <td><?php echo $products[$i]->nama; ?></td>
                    <td><?php echo $products[$i]->nomor_asli; ?></td>
                    <td><?php echo $products[$i]->make; ?></td>
                </tr>
                <?php } ?>
                </tbody>
            </table>
